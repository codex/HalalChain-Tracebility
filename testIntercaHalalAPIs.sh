...
curl -s -X POST \
  ...
  -d '{
	...
	"channelConfigPath":"../fabric-ca/halal/channel-artifacts/channel.tx",
	"orderer": "orderer1.hlcorderer.com"
}'
echo
echo
sleep 5
...
curl -s -X POST \
  ...
  -H "content-type: application/json" \
  -d '{
	"peers": ["peer1.hlc.com","peer2.hlc.com"]
}'
echo
echo
...
curl -s -X POST \
  ...
  -H "content-type: application/json" \
  -d '{
	"peers": ["peer1.creater.com","peer2.creater.com"]
}'
echo
echo
...
curl -s -X POST \
  ...
  -H "content-type: application/json" \
  -d '{
	"peers": ["peer1.transfer.com","peer2.transfer.com"]
}'
echo
echo
...
curl -s -X POST \
  ...
  -H "content-type: application/json" \
  -d '{
	"peers": ["peer1.seller.com","peer2.seller.com"]
}'
echo
echo
...
curl -s -X POST \
  ...
  -d '{
	"fcn":"move",
	"args":["a","b","10"],
	"peers": ["peer1.hlc.com","peer1.creater.com"]
}'
echo
echo
...
#echo
#curl -s -X GET \
#  "http://localhost:4000/chaincodes?peer=peer0.hlc.com" \
#  -H "authorization: Bearer $ORG1_TOKEN" \
#  -H "content-type: application/json"
#echo
#echo
...
#echo
#curl -s -X GET \
#  "http://localhost:4000/channels/mychannel/chaincodes?peer=peer0.hlc.com" \
#  -H "authorization: Bearer $ORG1_TOKEN" \
#  -H "content-type: application/json"
#echo
#echo
...
#echo
#curl -s -X GET \
#  "http://localhost:4000/channels?peer=peer0.hlc.com" \
#  -H "authorization: Bearer $ORG1_TOKEN" \
#  -H "content-type: application/json"
#echo
#echo
